...
bool biopsy_inference::InitNormlizedData() {
    // Load the mean data
...
bool biopsy_inference::NormalizeData (
...
//yuv420 Inference
// bool biopsy_inference::Inference(std::vector<ImageData<u_int8_t>> resized_imgs,
...
//         {
//           face_imgs[ind].infe_res.head_pose[k_pose] = result1[k_pose] * 50;
//           k_pose += 1;
//         }
//     }
...
bool biopsy_inference::ArrangeFaceMarkInfo(
...
void biopsy_inference::EnrichFacePosition(int *face_position, FaceFeature *face_feature) {
